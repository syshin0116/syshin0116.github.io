...
Homebrew를 먼저 설치한 후 다음 명령어로 대부분의 앱을 한 번에 설치할 수 있다:
...
# 필수 앱 설치
brew install --cask raycast rectangle iterm2 visual-studio-code obsidian mos
