...
draft: false
enableToc: true
summary: '| `.shape` | 데이터의 행과 열의 수를 확인 | | `.head()` | 데이터의 처음 몇 줄(기본적으로 5줄)을 보여줌
  |'
published: 2023-11-30 20:58 +0900
modified: 2023-11-30 20:58 +0900
layout: post
categories:
- 자격증
- 빅분기
...
> [!summary]
> 
> | `.shape` | 데이터의 행과 열의 수를 확인 | | `.head()` | 데이터의 처음 몇 줄(기본적으로 5줄)을 보여줌 |
