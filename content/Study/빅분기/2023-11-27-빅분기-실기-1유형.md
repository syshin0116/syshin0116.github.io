...
draft: false
enableToc: true
summary: 1. 데이터 타입(object, int, float, bool 등) 2. 기초통계량(평균, 중앙값, 사분위수, IQR, 표준편차 등)
published: 2023-11-27 21:10 +0900
modified: 2023-11-27 21:10 +0900
layout: post
categories:
- 자격증
- 빅분기
...
> [!summary]
> 
> 1. 데이터 타입(object, int, float, bool 등) 2. 기초통계량(평균, 중앙값, 사분위수, IQR, 표준편차 등)
