...
draft: false
enableToc: true
summary: COPY --from=build /app/target/*.jar app.jar CMD ["java", "-jar", "app.jar"]
published: 2024-04-05 20:15 +0900
modified: 2024-04-05 20:15 +0900
layout: post
categories:
- ETC
- Docker
...
> [!summary]
> 
> COPY --from=build /app/target/*.jar app.jar CMD ["java", "-jar", "app.jar"]
