...
draft: false
enableToc: true
summary: '> Anchor Box의 크기는 고정하되, Feature map의 크기를 줄여나간다 => MaxPooling과 같은 효과 > AnchorBox
  덕분에 Selective Search보다 계산량이 적음 => 훈련할떈 모르겠으나 사용할떈 빠름'
published: 2023-11-23 10:06 +0900
modified: 2023-11-23 10:06 +0900
layout: post
categories:
- SeSAC
- Computer-Vision
