...
draft: false
enableToc: true
summary: 2. Options -> Add-ons -> Image Analytics 검색, 설치 2. 파일을 더블 클릭하여 옵셩 창 열고, 다운로드한
  데이터 설정
published: 2023-11-21 12:17 +0900
modified: 2023-11-21 12:17 +0900
layout: post
categories:
- SeSAC
- Computer-Vision
...
> [!summary]
> 
> 2. Options -> Add-ons -> Image Analytics 검색, 설치 2. 파일을 더블 클릭하여 옵셩 창 열고, 다운로드한 데이터 설정
